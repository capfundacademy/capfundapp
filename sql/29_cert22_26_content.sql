...
(v_quiz, 'The OneRD platform consolidates which four USDA programs?', 'RMAP, IRP, RBDG, REDLG', 'B&I, Community Facilities, Water & Waste, REAP', 'Section 502, 504, 515, 538', 'FSA Farm Loans, BIA, CDFI, EDA', 'B', 'OneRD consolidates Business & Industry (B&I), Community Facilities (CF), Water & Waste Disposal (WWD), and Rural Energy for America Program (REAP) under a single regulatory framework (7 CFR Part 5001).', 1),
(v_quiz, 'What is the maximum B&I loan amount?', '$5 million', '$10 million', '$25 million', '$50 million', 'C', 'The Business & Industry Guaranteed Loan program has a maximum loan amount of $25 million.', 2),
(v_quiz, 'What guarantee rate does the B&I program provide for loans up to $5 million?', '60%', '70%', '80%', '90%', 'C', 'B&I guarantee rates are 80% for loans up to $5 million, 70% for loans $5-10 million, and 60% for loans over $10 million.', 3),
(v_quiz, 'Can a nonprofit CDFI be a direct B&I lender?', 'Yes, any nonprofit can apply', 'No, only federally regulated financial institutions can be approved B&I lenders', 'Yes, if they have CDFI certification', 'Only if they partner with a commercial bank', 'B', 'B&I approved lenders must be federally regulated financial institutions (banks, credit unions, insurance companies). Nonprofits can partner with approved lenders but generally cannot be direct B&I lenders.', 4),
(v_quiz, 'Under what regulation does the OneRD platform operate?', '7 CFR Part 4280', '7 CFR Part 5001', '2 CFR Part 200', '13 CFR Part 120', 'B', 'The OneRD Guarantee Loan Initiative operates under 7 CFR Part 5001, which standardized the application and servicing processes for B&I, CF, WWD, and REAP programs.', 5),
(v_quiz, 'What tool can be used to verify rural eligibility for USDA programs?', 'SAM.gov', 'Grants.gov', 'eligibility.sc.egov.usda.gov', 'sba.gov/funding-programs', 'C', 'USDA provides an online eligibility mapping tool at eligibility.sc.egov.usda.gov for verifying whether a specific address or area qualifies as rural under various USDA programs.', 6),
(v_quiz, 'What is a feasibility study, and when is it required for B&I loans?', 'A credit report — required for all loans', 'An environmental analysis — required for loans over $1 million', 'An analysis of financial and market viability — required for larger or complex projects', 'A demographic study — required for all rural loans', 'C', 'A feasibility study analyzes the financial projections, market demand, and viability of a project. USDA requires feasibility studies for larger B&I loans and complex projects.', 7),
(v_quiz, 'Which of the following is an eligible use of B&I loan proceeds?', 'Political campaign contributions', 'Purchase of a rural manufacturing facility', 'Charitable grants to community organizations', 'Personal expenses of business owners', 'B', 'B&I loans can be used for eligible business purposes including real estate, equipment, working capital, and business acquisition — all in eligible rural areas.', 8),
(v_quiz, 'The Rural Energy for America Program (REAP) is part of which platform?', 'SBA programs', 'USDA OneRD', 'HUD risk-sharing', 'EPA environmental finance', 'B', 'REAP (Rural Energy for America Program) is one of the four programs consolidated under the USDA OneRD platform, providing guaranteed loans and grants for renewable energy and energy efficiency projects.', 9),
(v_quiz, 'A community organization wants to help rural businesses access B&I financing. What is their most effective role?', 'Apply to become an approved B&I lender', 'Provide technical assistance to borrowers and build referral relationships with approved lenders', 'Establish a state-chartered bank', 'Apply for CDFI certification first', 'B', 'Community organizations are most effective as technical assistance providers and referral partners — helping borrowers prepare applications and connecting them with approved B&I lenders.', 10)
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (quiz_id, question_text, option_a, option_b, option_c, option_d, correct_answer, explanation, sort_order) VALUES
(v_quiz, 'What is the maximum USDA guarantee percentage for Section 502 Guaranteed loans?', '75%', '80%', '90%', '100%', 'C', 'USDA guarantees up to 90% of Section 502 Guaranteed loans, significantly reducing lender risk for rural mortgage origination.', 1),
(v_quiz, 'Who administers the Section 502 Direct Loan Program?', 'FHA-approved mortgage lenders', 'State housing finance agencies', 'USDA Rural Development directly', 'Ginnie Mae-approved issuers', 'C', 'USDA Rural Development is the direct lender in the Section 502 Direct program — USDA makes the loans itself to very low- and low-income rural borrowers.', 2),
(v_quiz, 'Section 538 guarantees loans for what type of rural property?', 'Single-family homeownership', 'Multifamily affordable rental housing', 'Commercial real estate', 'Agricultural land', 'B', 'Section 538 provides loan guarantees for the construction or improvement of affordable rural rental housing (multifamily).', 3),
(v_quiz, 'What income level does Section 502 Direct primarily serve?', '150% of area median income', '115% of area median income', 'Very low- and low-income households', 'Moderate-income households only', 'C', 'The Section 502 Direct Loan Program targets very low- and low-income rural households who cannot obtain financing through conventional or guaranteed programs.', 4),
(v_quiz, 'Farm Labor Housing (Section 514/516) serves which population?', 'Rural homebuyers seeking first mortgages', 'Domestic farm laborers in need of affordable housing', 'Farmers seeking operating loans', 'Rural seniors needing repair assistance', 'B', 'USDA Sections 514 and 516 specifically address the housing needs of domestic farm laborers in rural areas — one of the most underserved rural populations.', 5),
(v_quiz, 'What is a Section 502 Guaranteed borrower income limit?', 'Below poverty level only', '80% of area median income', '115% of area median income', 'No income limit', 'C', 'Section 502 Guaranteed borrowers must generally have incomes at or below 115% of the area median income.', 6),
(v_quiz, 'Section 515 is best described as:', 'A state-level housing grant program', 'A USDA direct loan program for affordable rural rental housing', 'An FHA insurance program for rural mortgages', 'A CDFI program for rural developers', 'B', 'Section 515 is a USDA direct loan program that has financed affordable rural rental housing at below-market interest rates — the existing portfolio represents decades of rural housing investment.', 7),
(v_quiz, 'A rural affordable housing project typically requires multiple capital layers. This is called:', 'A USDA consolidated application', 'A capital stack', 'A guarantee pool', 'A relending structure', 'B', 'A capital stack is the combination of multiple financing sources — grants, debt, equity, tax credits — that together fund a single project.', 8),
...
(v_quiz, 'What is the role of a community organization in the Section 502 Direct program?', 'Originate and service direct USDA loans', 'Provide referrals, application assistance, and homebuyer counseling', 'Administer the USDA guarantee', 'Manage the Section 502 loan servicing portfolio', 'B', 'Since USDA originates Section 502 Direct loans itself, community organizations serve most effectively as referral partners and application assistance providers.', 10)
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (quiz_id, question_text, option_a, option_b, option_c, option_d, correct_answer, explanation, sort_order) VALUES
(v_quiz, 'What percentage does FSA guarantee on guaranteed farm loans?', 'Up to 75%', 'Up to 80%', 'Up to 90%', 'Up to 95%', 'D', 'FSA guarantees up to 95% of guaranteed farm ownership and operating loans, one of the highest guarantee rates in any federal lending program.', 1),
(v_quiz, 'What is the maximum FSA Microloan amount?', '$25,000', '$50,000', '$100,000', '$150,000', 'B', 'FSA Microloans have a maximum of $50,000 and use a simplified application process designed for small-scale and beginning farmers.', 2),
(v_quiz, 'How is a "beginning farmer" defined for FSA purposes?', 'First-time loan applicant', 'Farmer with less than 10 years of experience', 'Farmer under age 35', 'Farmer with less than 100 acres', 'B', 'FSA defines a beginning farmer as someone with 10 years or fewer of farming experience — not age-based.', 3),
(v_quiz, 'Which FSA program can guarantee a seller-financed land sale?', 'Guaranteed Farm Ownership Loan', 'Land Contract Guarantee', 'FSA Microloan', 'Beginning Farmer Down Payment Loan', 'B', 'The FSA Land Contract Guarantee protects a seller who finances the purchase of their farm directly to a buyer — FSA guarantees the buyer''s payments to the seller.', 4),
(v_quiz, 'What is the maximum Guaranteed Farm Ownership loan amount?', '$300,000', '$400,000', '$600,000', '$1 million', 'C', 'The maximum Guaranteed Farm Ownership loan amount is $600,000 (subject to inflation adjustments), compared to $300,000 for the Direct Farm Ownership loan.', 5),
(v_quiz, 'Who administers the FSA guaranteed farm loan program?', 'FSA makes the loans directly', 'Approved commercial lenders with FSA guarantees', 'State agricultural agencies', 'Farm Credit System only', 'B', 'FSA guaranteed loans are made by approved commercial lenders (primarily banks and credit unions) with FSA providing the guarantee — FSA does not originate these loans.', 6),
(v_quiz, 'Socially disadvantaged farmers are defined as:', 'Farmers below the poverty line', 'Members of racial or ethnic minority groups', 'Farmers in designated disaster areas', 'Farmers with more than $100,000 in debt', 'B', 'For FSA purposes, socially disadvantaged farmers are members of racial or ethnic minority groups — a classification that unlocks priority access to certain loan programs and reserved funds.', 7),
(v_quiz, 'What is the Farm Credit System?', 'USDA''s direct lending division', 'A network of federally chartered cooperative lenders serving agricultural markets', 'SBA''s rural lending program', 'A group of state agricultural agencies', 'B', 'The Farm Credit System is a nationwide network of federally chartered cooperative lending institutions (Farm Credit Banks, Agricultural Credit Associations) that serve farmers, rural homeowners, and agricultural businesses.', 8),
(v_quiz, 'FSA Direct Operating Loans can be used for which purpose?', 'Purchasing farmland only', 'Annual farm expenses including seed, feed, fertilizer, and equipment', 'Building farm structures only', 'Paying off existing farm debt', 'B', 'FSA Direct Operating Loans cover annual production expenses — seed, feed, fertilizer, pesticides, fuel, farm supplies, and the personal living expenses of farmers during the growing season.', 9),
(v_quiz, 'A community organization working with beginning farmers wants to help them access federal credit. What is the most appropriate first step?', 'Apply to become an FSA-approved lender', 'Contact the local FSA county office and learn about current program availability', 'Establish a Farm Credit Association', 'Apply for CDFI certification', 'B', 'The local FSA county office is the primary point of contact for beginning farmer loans, program availability, and application assistance. Community organizations should build relationships with their county FSA office.', 10)
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (quiz_id, question_text, option_a, option_b, option_c, option_d, correct_answer, explanation, sort_order) VALUES
(v_quiz, 'FHA mortgage insurance is administered by which agency?', 'USDA Rural Development', 'Department of Veterans Affairs', 'HUD Federal Housing Administration', 'Fannie Mae', 'C', 'The Federal Housing Administration (FHA) is a division of HUD that insures mortgage loans made by approved private lenders.', 1),
(v_quiz, 'What is the minimum down payment for FHA Title II loans with a credit score of 580 or higher?', '0%', '3.5%', '5%', '10%', 'B', 'FHA requires a 3.5% down payment for borrowers with credit scores of 580 or higher — one of the lowest down payment requirements among conventional mortgage programs.', 2),
(v_quiz, 'VA loans are available to which group?', 'All low-income borrowers in rural areas', 'Veterans, service members, and eligible surviving spouses', 'Native American borrowers only', 'First-time homebuyers nationwide', 'B', 'VA mortgage guarantees are available to eligible veterans, active-duty service members, and qualifying surviving spouses as a benefit of military service.', 3),
(v_quiz, 'What is the primary purpose of HUD Section 184?', 'To insure multifamily housing loans', 'To provide mortgage guarantees for loans on tribal trust land and to Native borrowers', 'To finance rural multifamily development', 'To guarantee farm operating loans', 'B', 'HUD Section 184 was created specifically to address barriers to mortgage lending in tribal communities, providing guarantees for loans to Native American and Alaska Native borrowers.', 4),
(v_quiz, 'Which mortgage program requires NO down payment and NO private mortgage insurance?', 'FHA Title II', 'USDA Section 502 Guaranteed', 'VA Loan Guarantee', 'Fannie Mae HomeReady', 'C', 'VA loans require no down payment and no private mortgage insurance — the most favorable terms available to eligible borrowers.', 5),
(v_quiz, 'To originate FHA-insured mortgages, a lender must:', 'Have CDFI certification', 'Be an FHA-approved mortgagee with a net worth of at least $1 million', 'Be a state-chartered bank', 'Register with NMLS only', 'B', 'FHA approval requires institutional accreditation, minimum net worth ($1 million for supervised lenders), a quality control plan, and compliance with HUD handbook requirements.', 6),
(v_quiz, 'Section 184A serves which population?', 'Alaska Native communities', 'Native Hawaiian families', 'American Indian tribal members in the continental U.S.', 'All indigenous peoples in the United States', 'B', 'Section 184A specifically serves Native Hawaiian families, providing mortgage guarantees for loans on Hawaiian home lands — a parallel program to Section 184.', 7),
(v_quiz, 'What is a key reason conventional mortgage lending has historically been limited on tribal trust land?', 'Tribal members have low credit scores', 'Title insurance and conventional mortgage underwriting cannot apply to trust land', 'USDA prohibits mortgage lending in tribal areas', 'There is no demand for homeownership in tribal communities', 'B', 'Tribal trust land cannot be foreclosed on through conventional processes, and title insurance is difficult or impossible to obtain, making conventional mortgage lending impractical without a federal guarantee.', 8),
(v_quiz, 'A rural housing counseling agency wants to help veteran borrowers in a rural area find the best mortgage terms. Which program combination should they explore first?', 'FHA and Fannie Mae', 'VA Loan Guarantee and USDA Section 502 Guaranteed', 'USDA B&I and REAP', 'HUD Section 184 and SBA Microloan', 'B', 'Veterans living in eligible rural areas may qualify for both VA and USDA Section 502 programs. The VA typically offers better terms (no down payment, no MIP), but USDA can be an alternative for veterans who don''t use VA benefits.', 9),
(v_quiz, 'Which of the following is a key first step for a community organization serving tribal members who want to buy homes?', 'Obtain a state lending license', 'Identify Section 184-approved lenders and build homebuyer education capacity', 'Apply to become a Ginnie Mae issuer', 'Apply for an FSA guarantee', 'B', 'Building relationships with Section 184-approved lenders and developing homebuyer education programming are the most actionable first steps for organizations serving tribal homebuyers.', 10)
ON CONFLICT DO NOTHING;
...
INSERT INTO quiz_questions (quiz_id, question_text, option_a, option_b, option_c, option_d, correct_answer, explanation, sort_order) VALUES
(v_quiz, 'What is a MAP lender?', 'A USDA-approved rural housing lender', 'A HUD-approved lender with delegated underwriting authority for FHA multifamily programs', 'A state-licensed mortgage company', 'A Fannie Mae seller/servicer for multifamily loans', 'B', 'MAP (Multifamily Accelerated Processing) lenders are HUD-approved institutions with delegated underwriting authority that allows them to process most FHA multifamily applications without full HUD review.', 1),
(v_quiz, 'Which FHA program is used for new construction and substantial rehabilitation of multifamily housing?', 'FHA 223(f)', 'FHA 221(d)(4)', 'FHA 241(a)', 'FHA 223(a)(7)', 'B', 'FHA 221(d)(4) is FHA''s primary program for new construction and substantial rehabilitation of multifamily housing, with loan terms up to 40 years plus construction period.', 2),
(v_quiz, 'What is the purpose of FHA 223(f)?', 'New construction of healthcare facilities', 'Acquisition or refinancing of existing multifamily properties', 'Streamlined refinancing of existing FHA loans', 'Supplemental loans for completed FHA projects', 'B', 'FHA 223(f) provides mortgage insurance for the acquisition or refinancing of existing multifamily properties at least three years old.', 3),
(v_quiz, 'What wage requirement applies to FHA-insured construction projects?', 'State minimum wage only', 'Davis-Bacon prevailing wage requirements', 'Federal minimum wage plus 10%', 'No wage requirements for affordable housing', 'B', 'Davis-Bacon Act prevailing wage requirements apply to construction projects financed with FHA-insured loans, requiring contractors to pay locally prevailing wages.', 4),
(v_quiz, 'FHA 232 provides mortgage insurance for which type of facility?', 'Rural multifamily housing', 'Healthcare facilities — nursing homes and assisted living', 'Tribal housing developments', 'Student housing at universities', 'B', 'FHA 232 (Lean 232) provides mortgage insurance for nursing homes, assisted living facilities, intermediate care facilities, and board and care homes.', 5),
(v_quiz, 'HUD 542(b) and 542(c) risk-sharing programs are designed to work with:', 'FHA MAP lenders', 'State Housing Finance Agencies and HUD-approved public entities', 'Fannie Mae and Freddie Mac', 'USDA Rural Development', 'B', 'HUD 542(b) and 542(c) risk-sharing programs allow state housing finance agencies and other HUD-approved public entities to share risk with HUD on multifamily mortgage insurance, enabling faster processing and more flexible underwriting.', 6),
(v_quiz, 'What is the maximum loan term for an FHA 221(d)(4) construction loan?', '20 years', '30 years', '40 years plus construction period', '50 years', 'C', 'FHA 221(d)(4) loans have terms up to 40 years for the permanent loan, plus a construction period of up to two years.', 7),
(v_quiz, 'What is FHA 223(a)(7)?', 'New construction insurance', 'Supplemental loan insurance', 'Streamlined refinancing for existing FHA-insured multifamily loans', 'Healthcare facility insurance', 'C', 'FHA 223(a)(7) provides streamlined refinancing for existing FHA-insured multifamily mortgages — faster and lower-cost than a full 223(f) refinance since the property is already in the insurance portfolio.', 8),
(v_quiz, 'A community development organization wants to finance a 50-unit affordable apartment project. Which financing approach should they explore?', 'SBA 7(a) loan only', 'FHA 221(d)(4) with MAP lender, combined with LIHTC equity', 'USDA Business & Industry guarantee', 'Section 502 Direct loans', 'B', 'A 50-unit affordable apartment project is an ideal candidate for FHA 221(d)(4) financing through a MAP lender, often combined with Low-Income Housing Tax Credit equity and other affordable housing sources.', 9),
