...
FROM qid CROSS JOIN (VALUES
  ...
  ('To originate Section 502 Guaranteed loans directly, an organization must:', '[{"id":"a","text":"Be a nonprofit with CDFI certification"},{"id":"b","text":"Meet USDA lender eligibility as a regulated financial institution"},{"id":"c","text":"Have five years of rural housing experience"},{"id":"d","text":"Submit a feasibility study to USDA"}]', 'b', 'Section 502 Guaranteed lenders must meet USDA''s lender eligibility requirements, which generally require being a federally regulated financial institution.', 9),
